...
namespace AoTomato.Domain.Helpers;
...
public static class StringExtensions
{
    ...
    {
        return input.RemoveMask(MaskChars);
    }
    ...
    {
        return JsonSerializer.Deserialize<Dictionary<string, string>>(str) ?? new Dictionary<string, string>();
    }

    public static Dictionary<string, T> ToDict<T>(this string str)
    {
        return JsonSerializer.Deserialize<Dictionary<string, T>>(str) ?? new Dictionary<string, T>();
    }

    public static string FromDict<T>(this Dictionary<string, T> str)
    {
